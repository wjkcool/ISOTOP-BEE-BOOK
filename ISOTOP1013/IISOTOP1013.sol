...
3） 对比ISOTOP1013和所在链标准合约的GAS费用差异
...
interface IISOTOP1013 {
     ...
     * See {Queryable-explicitOwnershipOf}
     */
     ...
     * grows too big for a single call of {Queryable-tokensOfOwner}.
     *
     * Requirements:
     *
     * - `start < stop`
     ...
     *
     * See {Queryable-tokensOfOwnerIn} for splitting the scan into
