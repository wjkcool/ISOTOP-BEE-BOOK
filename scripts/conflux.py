...
class ConfluxWeb3:
    ...
    # *编译合约，需要编译器支持并且源文件引用都在目录内，目前可以忽略
    ...
    # * 根据合约的abi和bytecode部署合约，需要读取ABI文件
    ...
    # ! use this function to encode ABI function:
    # !factory.encodeABI(fn_name='register', args=['dd', web3.admin.address])
