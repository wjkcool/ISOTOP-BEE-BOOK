...
class ConfluxWeb3:
    ...
    def loadDDS(self, contract: str):
        return self.w3.address(self.dds.functions.toAddress(self.dds.functions.get(
            'ISOTOP', 'BEE_' + contract.upper()+'_ADDRESS').call()).call(), self.chainId)
    ...
    def readDDSAddress(self, key: str):
        ...
        return ret, self.w3.address(ret, self.chainId)
